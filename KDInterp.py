"""
This is stolen shamelessly from Morgan Fouesneau
(https://github.com/mfouesneau?tab=repositories)
...
from bary import RbfInterpolator  # Not sure where bary comes from...
