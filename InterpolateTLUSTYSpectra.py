...
class Models:
  ...
  def GetArbitrarySpectrum(self, T, metal, logg, vmicro):
    ...
    T0, metal0, logg0, vmicro0 = self.grid[bestindex][0], self.grid[bestindex][1], self.grid[bestindex][2], self.grid[bestindex][3]
    ...
    newspectrum.y += (d_dT * (T - T0) +
                      d_dZ * (metal - metal0) +
                      d_dg * (logg - logg0) )#   Need to remove this parenthesis to enable microturbulent velocity too!+
  ...
  def GetClosestSpectrum(self, T, metal, logg, vmicro, weights=None):
    ...
    T, metal, logg, vmicro = self.grid[bestindex][0], self.grid[bestindex][1], self.grid[bestindex][2], self.grid[bestindex][3]
